...
WebUI.click(findTestObject('Object Repository/Amazon_Login_OR/Page_Online Shopping site in India Shop Onl_10c5f3/span_Hello, sign in'))
...
WebUI.setText(findTestObject('Object Repository/Amazon_Login_OR/Page_Amazon Sign In/input_Forgot Password_password'), 'amruthar@04')
